...
import { setUserName } from "../utils/store/userSlice"
...
const FormInput = ({ isSignUpPage, currValues, setCurrValue, setIsLoading }: inputType) => {
  ...
  const handleClick = async () => {
    ...
    if (result?.success) {
        dispatch(setUserName(currValues.username));
        navigate("/blogs"); 
