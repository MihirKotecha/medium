...
const Signin = () => {
  ...
  if (isLoading) {
    return (
      <div className="h-screen w-screen flex justify-normal items-center">
  ...
  return (
    <div className="grid grid-cols-1 h-screen justify-center items-center lg:grid-cols-2">
      ...
      <div className="flex justify-center flex-col items-center w-full h-screen">
        ...
        <FormInput isSignUpPage={false} currValues={signinInputs} setCurrValue={setSignInInput} setIsLoading={setIsLoading} />
      </div>
    </div>
  )
}
